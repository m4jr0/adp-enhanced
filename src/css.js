...
.hours-minutes-input:focus {
  border: 3px solid var(--global-emphasis);
  outline: none;
}

.hours-minutes-input-label {
  font-size: 0.9em;
}
