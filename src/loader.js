...
function addAdpEnhancedToggleButton () {
  ...
  adpToggleButton.id = 'adp-toggle-button'
  adpToggleButton.innerHTML = `<a target="_blank" href="">
    <svg width="2em" height="2em" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" id="adp-toggle-button-logo">
